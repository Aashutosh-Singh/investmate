  ...
  return (
    ...
    <Router>
      ...
      <div className="bg-gray-900 text-white min-h-screen flex flex-col">
        {/* Navbar */}
        <nav className="p-4 text-white w-full bg-zinc-950 border-b border-white/10 sticky top-0 z-50">
          <div className="container mx-auto flex justify-between items-center">
            ...
            {/* Mobile Navigation */}
            {isMobileMenuOpen && (
              <div className="absolute top-full left-0 w-full bg-zinc-950 border-b border-white/10 lg:hidden">
        ...
        <main className="flex-grow">
          ...
          {/* RAG Chatbot — floating widget (replaces old Streamlit link) */}
            <ChatWidget />
        ...
        <footer className="bg-gray-800 text-gray-400 p-4 text-center">
          ...
          <p className="text-sm">© 2026 InvestMate. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </Router>
